...
export function OpportunityDashboardTabBar({
  ...
  return (
    <div className={cn("shrink-0 px-4 pb-3 pt-1", className)}>
      <div
        role="tablist"
        aria-label={field.dashboardTabAria}
        className="flex rounded-[14px] bg-[#f2f4f6] p-1"
      >
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={cn(
                "relative min-w-0 flex-1 rounded-[11px] py-2.5 transition-colors duration-200",
            ...
            >
              {active ? (
                <motion.span
                  ...
                  className="absolute inset-0 rounded-[11px] bg-white shadow-[0_1px_4px_rgba(0,0,0,0.08)]"
