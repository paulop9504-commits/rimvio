  ...
  return (
    <section className={cn("overflow-hidden p-4", IOS.cardSm, className)}>
      <div className="flex items-start justify-between gap-3">
        ...
        <span className="shrink-0 rounded-full bg-[#7B61FF]/10 px-2.5 py-1 text-[10px] font-semibold text-[#7B61FF]">
          ...
          return (
            <button
              ...
              className={cn(
                ...
                active
                  ? "bg-[#7B61FF]/8 ring-2 ring-[#7B61FF]/35 shadow-sm"
            ...
            >
              <span
                className={cn(
                  ...
                  active ? "bg-[#7B61FF] text-white" : "bg-white text-foreground"
                )}
                aria-hidden
              >
                {active ? (
