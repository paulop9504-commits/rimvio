                  ...
                  <div className="grid gap-2">
                    {friendTargets.map((room) => (
                      <button
                        ...
                        className={cn(
                          "flex items-center gap-3 rounded-2xl px-4 py-3 text-left",
                          "bg-[#007AFF]/8 ring-1 ring-[#007AFF]/18 transition-colors hover:bg-[#007AFF]/12"
                        )}
                      >
                        <span className="flex size-10 items-center justify-center rounded-xl bg-[#007AFF]/12 text-[#007AFF]">
