                  ...
                  >
                    <div
                      className={cn(
                        ...
                        "bg-background ring-1 ring-black/[0.04]",
                        active && "ring-0"
                      )}
                    >
                      <Icon
                ...
                >
                  ...
                  >
                    ...
                    >
                      {remoteLoading ? (
                        <Loader2
                          className="size-[1.2rem] animate-spin text-[#007AFF]"
                          strokeWidth={2.2}
                        />
                      ) : (
                        <Zap
                          className="size-[1.2rem] text-[#007AFF]"
                          strokeWidth={2.2}
                          fill="currentColor"
                        />
                      )}
                    ...
                    {remote.expanded && remote.primary && !remoteLoading ? (
                      <span className="absolute -right-0.5 -top-0.5 size-2.5 rounded-full border-2 border-background bg-[#007AFF]" />
                    ) : null}
                  </div>
                  <span className="max-w-full truncate text-[11px] font-semibold leading-none tracking-tight text-[#007AFF]">
                    ...
                    <>
                      ...
                      <motion.div
                        ...
                        className={cn(
                          ...
                          "overflow-hidden rounded-[18px] border border-white/70 bg-white/95 p-2",
                          "shadow-[0_16px_40px_-24px_rgba(15,23,42,0.45)] backdrop-blur-xl ring-1 ring-black/[0.04]"
                        )}
                      >
                        {remote.signalLine ? (
                          ...
                          {remoteActions.map((action) => (
                            <button
                              ...
                              className={cn(
                                ...
                                "text-foreground transition-colors hover:bg-[#F2F2F7] active:scale-[0.99]"
                              )}
                            >
