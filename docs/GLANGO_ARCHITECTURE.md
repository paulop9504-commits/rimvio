# Glango Architecture — Locked Decisions

> **Status:** 설계 리뷰 완료 · 구현 진행 중
>
> **관련:** [GLANGO_PRODUCT.md](./GLANGO_PRODUCT.md) · [GLANGO_HANDOFF.md](./GLANGO_HANDOFF.md)

---

## 1. 한 줄 정의

> **Glango = deterministic action system + AI fallback**
>
...
4. **Glango 철학** — LLM은 사용자에게 보이지 않음. 버튼만 보임.
