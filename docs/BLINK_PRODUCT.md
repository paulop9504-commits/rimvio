# Blink 제품 정의서 (Product Brief)

> **대상:** PM, 디자이너, 마케팅, 다음 AI 에이전트
>
> **관련 문서:** [BLINK_HANDOFF.md](./BLINK_HANDOFF.md) — 기술/코드 핸드오프
>
> **제품명:** Blink 👀
>
...
**Blink는 북마크 앱이 아니다.** 사용자가 어디서든 링크를 공유하면, Blink가 그 링크를 **지금 당장 누를 수 있는 행동 버튼**으로 바꿔 주는 OS 레이어다.
...
- 이모지: 👀 (Blink 정체성), ▶️ 🛒 🎁 등 action 라벨에 sparingly
...
링크를 **읽을 거리**가 아니라 **누를 거리**로 바꾸는 Blink의 핵심 엔진.
...
**Blink moat:** Share Target 진입 + domain enricher network + intent bin 누적 데이터.
