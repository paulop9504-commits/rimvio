# Glango 프로젝트 핸드오프 (AI / 개발자용)

> **목적:** 이 문서만 읽고도 Glango 코드베이스의 구조, 흐름, 규칙, 미완성 항목을 파악할 수 있게 한다.
>
...
>
> **아키텍처:** [GLANGO_ARCHITECTURE.md](./GLANGO_ARCHITECTURE.md)
>
