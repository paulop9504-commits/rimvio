...
assert.equal(resolveGlobeTileStyleForLevel(8), "light");
assert.match(globeTileEngineUrl(120, 210, 8), /style=light/);
assert.match(globeTileEngineUrl(120, 210, 3), /style=light/);
