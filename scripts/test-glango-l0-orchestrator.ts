...
const study = routeGlangoL0({ kind: "capture", text: physicsBook });
...
const philosophyMedicine = routeGlangoL0({
  kind: "capture",
  text: [
...
console.log("test-glango-l0-orchestrator: ok");
