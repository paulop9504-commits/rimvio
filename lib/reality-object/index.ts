...
/** Reality OS engine object (distinct from RealityObjectV1 on events). */
export type {
  RealityObject,
  RealityObjectState,
  RealityObjectRelationship,
  CommitHistoryEntry,
} from "@/lib/reality-object/engine-types";
export { REALITY_OBJECT_TRANSITIONS } from "@/lib/reality-object/engine-types";
export {
  createRealityObject,
  getRealityObject,
  transitionRealityObject,
  listRealityObjects as listEngineRealityObjects,
  clearRealityObjects,
