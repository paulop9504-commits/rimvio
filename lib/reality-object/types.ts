/**
 * Reality Object Model — Pin = living entity with state, actions, history.
 */
...
export type RealityObjectRelationship = {
  ...
  readonly kind: "belongs_to" | "depends_on" | "conflicts_with" | "satisfies" | "near" | "alternative";
};
...
export const REALITY_OBJECT_TRANSITIONS: Record<RealityObjectState, readonly RealityObjectState[]> = {
