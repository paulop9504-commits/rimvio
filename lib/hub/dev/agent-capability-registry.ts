...
export const RIMVIO_AGENT_CAPABILITIES: readonly RimvioAgentCapability[] = [
  ...
  { id: 4, slug: "context_persistence", name: "Context Persistence", roleKo: "이전 대화와 현재 작업 연결", category: "conversation_intent", phase: 1, status: "implemented", modules: ["lib/hub/dev/conversation-memory.ts", "lib/agent/conversation/intent-types.ts"] },
  { id: 5, slug: "reference_resolution", name: "Reference Resolution", roleKo: "그거/이 기능/여기 해석", category: "conversation_intent", phase: 1, status: "implemented", modules: ["lib/hub/dev/conversation-memory.ts"] },
  ...
  { id: 8, slug: "implicit_intent", name: "Implicit Intent Detection", roleKo: "직접 말하지 않은 의도 추론", category: "conversation_intent", phase: 1, status: "implemented", modules: ["lib/hub/dev/conversation-memory.ts"] },
  { id: 9, slug: "goal_change_detection", name: "Goal Change Detection", roleKo: "작업 중 새 목표 감지", category: "conversation_intent", phase: 1, status: "implemented", modules: ["lib/hub/dev/conversation-memory.ts", "lib/hub/dev/hub-agent-controller.ts"] },
  { id: 10, slug: "conversation_memory", name: "Conversation Memory", roleKo: "작업 맥락 지속", category: "conversation_intent", phase: 1, status: "implemented", modules: ["lib/hub/dev/conversation-memory.ts"] },
  ...
  { id: 25, slug: "definition_search", name: "Definition Search", roleKo: "정의 찾기", category: "context_code_discovery", phase: 1, status: "implemented", modules: ["hub-workspace-tools:code.findDefinition", "lib/hub/dev/coding-agent/repo-workspace.ts"] },
  ...
  { id: 27, slug: "import_analysis", name: "Import Analysis", roleKo: "import 관계 분석", category: "context_code_discovery", phase: 1, status: "implemented", modules: ["hub-workspace-tools:code.analyzeImports", "lib/hub/dev/coding-agent/repo-workspace.ts"] },
  { id: 28, slug: "call_graph_analysis", name: "Call Graph Analysis", roleKo: "호출 관계 분석", category: "context_code_discovery", phase: 1, status: "implemented", modules: ["hub-workspace-tools:code.callGraph", "lib/hub/dev/coding-agent/repo-workspace.ts"] },
  ...
  { id: 30, slug: "cross_file_reasoning", name: "Cross-file Reasoning", roleKo: "여러 파일 연결 이해", category: "context_code_discovery", phase: 1, status: "partial", modules: ["lib/hub/dev/coding-agent/repo-workspace.ts", "lib/hub/dev/operator-llm-planner.ts"] },
  ...
  { id: 39, slug: "implementation_planning", name: "Implementation Planning", roleKo: "코드 구현 계획", category: "platform_planning", phase: 1, status: "implemented", modules: ["lib/hub/dev/operator-llm-planner.ts", "lib/hub/dev/platform-agent/coding-plan.ts"] },
  ...
  { id: 51, slug: "file_creation", name: "File Creation", roleKo: "파일 생성", category: "coding_agent", phase: 2, status: "implemented", modules: ["hub-workspace-tools:code.createFile", "lib/hub/dev/coding-agent/repo-workspace.ts"] },
  { id: 52, slug: "file_modification", name: "File Modification", roleKo: "파일 수정", category: "coding_agent", phase: 2, status: "implemented", modules: ["hub-workspace-tools:code.modifyFile", "lib/hub/dev/coding-agent/repo-workspace.ts"] },
  { id: 53, slug: "file_deletion", name: "File Deletion", roleKo: "파일 삭제", category: "coding_agent", phase: 2, status: "implemented", modules: ["hub-workspace-tools:code.deleteFile", "lib/hub/dev/coding-agent/repo-workspace.ts"] },
  ...
  { id: 56, slug: "class_editing", name: "Class Editing", roleKo: "클래스 수정", category: "coding_agent", phase: 2, status: "partial", modules: ["hub-workspace-tools:code.transform", "lib/hub/dev/coding-agent/repo-workspace.ts"] },
  { id: 57, slug: "code_generation", name: "Code Generation", roleKo: "코드 생성", category: "coding_agent", phase: 2, status: "implemented", modules: ["lib/hub/dev/operator-llm-planner.ts", "hub-workspace-tools:code.createFile"] },
  { id: 58, slug: "code_transformation", name: "Code Transformation", roleKo: "코드 변환", category: "coding_agent", phase: 2, status: "implemented", modules: ["hub-workspace-tools:code.transform"] },
  { id: 59, slug: "refactoring", name: "Refactoring", roleKo: "코드 구조 개선", category: "coding_agent", phase: 2, status: "partial", modules: ["hub-workspace-tools:code.transform", "lib/hub/dev/operator-llm-planner.ts"] },
  ...
  { id: 61, slug: "test_discovery", name: "Test Discovery", roleKo: "관련 테스트 찾기", category: "build_test_debug", phase: 3, status: "implemented", modules: ["hub-workspace-tools:test.discover", "lib/hub/dev/coding-agent/repo-verify.ts"] },
  { id: 62, slug: "test_generation", name: "Test Generation", roleKo: "테스트 생성", category: "build_test_debug", phase: 3, status: "implemented", modules: ["hub-workspace-tools:test.generate", "lib/hub/dev/coding-agent/repo-verify.ts"] },
  { id: 63, slug: "unit_test_execution", name: "Unit Test Execution", roleKo: "Unit Test", category: "build_test_debug", phase: 3, status: "implemented", modules: ["hub-workspace-tools:test.run", "lib/hub/dev/coding-agent/repo-verify.ts"] },
  { id: 64, slug: "integration_test_execution", name: "Integration Test Execution", roleKo: "Integration Test", category: "build_test_debug", phase: 3, status: "implemented", modules: ["lib/hub/dev/coding-agent/repo-verify.ts"] },
  { id: 65, slug: "e2e_test_execution", name: "E2E Test Execution", roleKo: "E2E Test", category: "build_test_debug", phase: 3, status: "implemented", modules: ["hub-workspace-tools:test.e2e", "lib/hub/dev/coding-agent/repo-verify.ts"] },
  { id: 66, slug: "build_execution", name: "Build Execution", roleKo: "Build", category: "build_test_debug", phase: 3, status: "implemented", modules: ["hub-workspace-tools:build.run", "lib/hub/dev/coding-agent/repo-verify.ts"] },
  { id: 67, slug: "lint_execution", name: "Lint Execution", roleKo: "Lint", category: "build_test_debug", phase: 3, status: "implemented", modules: ["hub-workspace-tools:lint.run"] },
  { id: 68, slug: "type_check", name: "Type Check", roleKo: "Type 검사", category: "build_test_debug", phase: 3, status: "implemented", modules: ["hub-workspace-tools:typecheck.run"] },
  ...
  { id: 78, slug: "regression_repair", name: "Regression Repair", roleKo: "회귀 수정", category: "self_repair_loop", phase: 3, status: "implemented", modules: ["lib/hub/dev/coding-agent/regression-repair.ts", "lib/hub/dev/hub-agent-loop.ts"] },
  ...
  { id: 82, slug: "dev_server_control", name: "Dev Server Control", roleKo: "개발 서버 관리", category: "runtime_preview_browser", phase: 4, status: "implemented", modules: ["lib/hub/dev/coding-agent/dev-server.ts", "hub-workspace-tools:server.start"] },
