...
export const copy = {
  ...
  globe: {
    ...
    field: {
      ...
      dashboardTabAria: "맞춤 · Pending Reality 탭",
      dashboardTabQueueHint: "AI가 준비한 Operation · 승인하면 Reality가 바뀌어요",
      ...
      realityControlSubtitle: "AI가 결과물을 준비했어요 · 아직 Reality는 그대로예요",
      ...
      realityQueueEmptyBody: "지구에서 맥락을 만들면 Reality Queue에 쌓여요",
