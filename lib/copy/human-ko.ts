...
export const copy = {
  ...
  globe: {
    ...
    contextAgentComposeHint: "근처 맛집·숙소·놀거리·약국까지 말하면 맞춰 드려요",
    ...
    globeComposePipelineIdle: "말할 준비",
    ...
    marketWizardPublishExternal: "외부 공개",
    ...
    marketManagePublishedToast: "밖 지구에 공개했어요",
    ...
    marketplaceDiscoveryReadOnlyHint: "밖 지구에서 보는 거래 카드예요.",
    ...
    provenanceVisibilityExternal: "밖 지구에서도 볼 수 있어요",
    ...
    field: {
      ...
      browseAllPill: "전체",
      browseNeedSeekingBody: "대화하려면 내 밖 지구에 구하기를 먼저 올려 주세요 · 내 밖 지구 탭에서 공개할 수 있어요",
      emptyBrowseTitle: "근처 밖 지구 자원이 아직 없어요",
      emptyBrowseBody: "이웃이 올린 중고·모임 맥락이 쌓이면 여기에 실시간으로 모여요",
      emptySeekingTitle: "아직 구하는 맥락이 없어요",
      emptySeekingBody: "내 밖 지구 탭에서 구하기를 올리면 맞춤 필터가 생겨요",
      emptyRowsTitle: "맞는 매물이 아직 없어요",
      emptyRowsBody: "조금만 기다리거나 찾는 조건을 넓혀 보세요",
      discoveryGateTitle: "밖 지구에서 볼 수 있어요",
      discoveryGateBody: "맞춤 관측은 밖 지구에서 열어 주세요",
      discoveryGateCta: "밖 지구로 전환",
      tradeCta: "대화하기",
      chatCta: "채팅하기",
      scheduleCta: "일정 맞추기",
  ...
  portal: {
    ...
    marketSuggestPublishBody: "밖 지구에서 맞는 거래를 찾을 수 있어요",
